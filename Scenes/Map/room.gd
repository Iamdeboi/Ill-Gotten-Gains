class_name Room
extends Resource
# The script for the grid-based data of a room, not to be confused with MapRoom, which is the visual and signal component
...
# For use in MONSTER and BOSS type rooms
